...
@Configuration
@EntityScan(basePackages = {"com.example.demo.외부API연동.C08FCM"})
@EnableJpaRepositories(basePackages = {"com.example.demo.외부API연동"})
public class JPAConfig {
    ...
    LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        entityManagerFactoryBean.setPackagesToScan("com.example.demo.외부API연동");

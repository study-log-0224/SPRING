(function (factory) {
	...
	if (typeof define === 'function' && define.amd) {
		// AMD
		define(['leaflet', 'FN_REST_OPENWEATHERMAP/ex/assets/Leaflet.KoreanTmsProviders/lib/proj4'], factory);
	} else if (typeof module !== 'undefined') {
		// Node/CommonJS
		L = require('leaflet');
		proj4 = require('FN_REST_OPENWEATHERMAP/ex/assets/Leaflet.KoreanTmsProviders/lib/proj4');
